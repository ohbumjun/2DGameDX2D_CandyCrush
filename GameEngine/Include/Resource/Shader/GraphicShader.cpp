...
{
	CDevice::GetInst()->GetDeviceContext()->VSSetShader(m_VS, nullptr, 0);
	CDevice::GetInst()->GetDeviceContext()->PSSetShader(m_PS, nullptr, 0);
	CDevice::GetInst()->GetDeviceContext()->HSSetShader(m_HS, nullptr, 0);
	CDevice::GetInst()->GetDeviceContext()->DSSetShader(m_DS, nullptr, 0);
	CDevice::GetInst()->GetDeviceContext()->GSSetShader(m_GS, nullptr, 0);

	CDevice::GetInst()->GetDeviceContext()->IASetInputLayout(m_InputLayout);
}
