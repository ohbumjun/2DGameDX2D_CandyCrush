...
{
	return static_cast<WIC_FLAGS>(static_cast<unsigned long>(a) | b & TEX_FILTER_MODE_MASK);
}

constexpr WIC_FLAGS operator|(TEX_FILTER_FLAGS a, WIC_FLAGS b)
{
	return static_cast<WIC_FLAGS>(a & TEX_FILTER_MODE_MASK | static_cast<unsigned long>(b));
}

// TEX_PMALPHA_SRGB match TEX_FILTER_SRGB
constexpr TEX_PMALPHA_FLAGS operator|(TEX_PMALPHA_FLAGS a, TEX_FILTER_FLAGS b)
{
	return static_cast<TEX_PMALPHA_FLAGS>(static_cast<unsigned long>(a) | b & TEX_FILTER_SRGB_MASK);
}

constexpr TEX_PMALPHA_FLAGS operator|(TEX_FILTER_FLAGS a, TEX_PMALPHA_FLAGS b)
{
	return static_cast<TEX_PMALPHA_FLAGS>(a & TEX_FILTER_SRGB_MASK | static_cast<unsigned long>(b));
}

// TEX_COMPRESS_SRGB match TEX_FILTER_SRGB
constexpr TEX_COMPRESS_FLAGS operator|(TEX_COMPRESS_FLAGS a, TEX_FILTER_FLAGS b)
{
	return static_cast<TEX_COMPRESS_FLAGS>(static_cast<unsigned long>(a) | b & TEX_FILTER_SRGB_MASK);
}

constexpr TEX_COMPRESS_FLAGS operator|(TEX_FILTER_FLAGS a, TEX_COMPRESS_FLAGS b)
{
	return static_cast<TEX_COMPRESS_FLAGS>(a & TEX_FILTER_SRGB_MASK | static_cast<unsigned long>(b));
}
...
inline HRESULT __cdecl LoadFromTGAMemory(const void*   pSource, size_t size, TexMetadata* metadata,
